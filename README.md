...
Ad esempio il sistema potrebbe permettere di organizzare una partita di calcetto inserendo specifici dati quali: **luogo, orario, titolo, descrizione, topic,nome dell'organizzatore e numero massimo di calciatori** necessario affinché l’evento abbia luogo. Se le condizioni saranno soddisfatte l'evento pubblico sarà reso non più visibile agli altri.
